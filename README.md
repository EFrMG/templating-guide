...
- Tooltips for acronyms galore!
  ...
  https://github.com/user-attachments/assets/e5a31e35-21e0-4619-8d99-a4ddc280f5db
...
- Sidebar that visually responds to the section actively viewed on the main content area of the page; it self-scrolls to have the "current" link in view at all times, with a debounced handler to prevent such action if the user happens to scroll at that moment (just before it triggers).
  ...
  https://github.com/user-attachments/assets/0454fd0f-af25-4112-adb2-810985ead4ba
...
- Theme switching between Handlebars and Nunjucks section.
  ...
  https://github.com/user-attachments/assets/f6f2b38d-06ff-4366-9299-654fd679c255

    </details>

- Code syntax highlighting with `Highlight.js`.
<img width="1103" height="705" alt="highlighting" src="https://github.com/user-attachments/assets/7f26e4c4-650d-4c43-81e9-00f17b18c793" />
